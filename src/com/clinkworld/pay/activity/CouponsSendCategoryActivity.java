...
import com.clinkworld.pay.adapter.CouponsSendListAdapter;
 ...
 * 优惠券类别
 */
public class CouponsSendCategoryActivity extends BaseActivity {

    private String couponId;
    private Dialog mLoadingDialog;
    private LeftBackRightTextTitleBar titleBar;
    private CouponsSendListAdapter mAdapter;
    ...
    SafeHandler safeHandler = new SafeHandler(CouponsSendCategoryActivity.this) {
        @Override
            ...
            switch (msg.what) {
                ...
                case MSG_CATEGORY_FAILURE:
                    ...
                    if (!TextUtils.isEmpty(errorMessage)) {
                        ToastUtils.showToast(CouponsSendCategoryActivity.this, errorMessage);
                    } else {
                        ToastUtils.showToast(CouponsSendCategoryActivity.this, getString(R.string.reg_httpclient_fail));
                    }
                    break;
            }
        }
    ...
    private void initView() {
        ...
        mAdapter = new CouponsSendListAdapter(CouponsSendCategoryActivity.this, couponsCategoryInfoList);
        ...
        mLoadingDialog = DialogUtils.getLoadingDialog(CouponsSendCategoryActivity.this, "正在加载...");
        mLoadingDialog.show();
        ClinkWorldApplication.httpHelper.execute(runnableCategory);
    }
    ...
    Runnable runnableCategory = new Runnable() {
        ...
        public void run() {
            ...
            String url = ServerUrl.BASE_URL + "/coupon/" + couponId + "/send_list";
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        for (int i = 0; i < listArray.length(); i++) {
                            ...
                            couponsCategoryInfo.setReceiverChannel(itemJSONObject.optInt("ReceiveChannel"));
                            couponsCategoryInfo.setReceiverTime(itemJSONObject.optString("ReceiveTime"));
