...
public class MultiScroll extends ScrollView {
    private static final String TAG = "MultiScroll";
    ...
    public boolean onInterceptTouchEvent(final MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE:
                CWLogUtils.d(TAG, TAG + " onInterceptTouchEvent MotionEvent.ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP:
                // Release the drag.
                CWLogUtils.d(TAG, TAG + " onInterceptTouchEvent MotionEvent.ACTION_UP");
                mTouchState = TOUCH_STATE_REST;
                intercept = false;
                break;
            case MotionEvent.ACTION_DOWN:
                CWLogUtils.d(TAG, TAG + " onInterceptTouchEvent MotionEvent.ACTION_DOWN");
                /*
