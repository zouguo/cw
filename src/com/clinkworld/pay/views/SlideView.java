...
public class SlideView extends LinearLayout {
    ...
    private OnBtnDeleteListener mBtnDeleteListener;
    private boolean hasStartScorll;
    // 内置容器的宽度 单位：dp
    ...
    private void initView() {
        ...
        mHolderWidth = Math.round(TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, mHolderWidth, getResources()
                        .getDisplayMetrics()));
        ((Button) findViewById(R.id.btn_delete)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mBtnDeleteListener != null) {
                    mBtnDeleteListener.onClick();
                }
            }
        });
    }
    ...
    public void setButtonText(CharSequence text) {
        ((Button) findViewById(R.id.btn_delete)).setText(text);
    }
    ...
    public void setmBtnDeleteListener(OnBtnDeleteListener mBtnDeleteListener) {
        this.mBtnDeleteListener = mBtnDeleteListener;
    }
...
//        onRequireTouchEvent(event);
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                CWLogUtils.d(TAG, "MotionEvent.ACTION_DOWN");
            ...
            case MotionEvent.ACTION_MOVE: {
                CWLogUtils.d(TAG, "MotionEvent.ACTION_MOVE");
                int deltaX = x - mLastX;
                int deltaY = y - mLastY;
                // 计算滑动终点是否合法，防止滑动越界
                ...
                if (Math.abs(deltaX) < Math.abs(deltaY) * TAN) {
                    ...
                    // 慢慢滑向终点
                    this.smoothScrollTo(newScrollX1, 0);
                    // 通知上层滑动事件
                    if (mOnSlideListener != null) {
                        mOnSlideListener.onSlide(this,
            ...
            case MotionEvent.ACTION_UP: {
                CWLogUtils.d(TAG, "MotionEvent.ACTION_UP");
