...
public class LeftTextRightTextTitleBar extends CoupletTitleBar {
    ...
    public LeftTextRightTextTitleBar(Activity activity) {
        super(activity);
    }
    ...
    public void onPostActivityLayout() {
        ...
        // Back
        viewBack = setLeftView(R.layout.titlebar_textleftright_view);
        // Title
    ...
    public void setLeftText(int resId) {
        if (viewBack == null) {
            ...
            ((TextView) viewBack.findViewById(R.id.tv_left)).setText(resId);
        }
    }
